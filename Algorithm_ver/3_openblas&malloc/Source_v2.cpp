...
void StoreMAE_style(float* list_pic_2d, int row, int col, int ch ) {
...
void StoreCSV(float* list_pic_2d, int row, int col, int ch, string filename ) {
...
void print_list_3D(float* list_3d, int row, int col, int ch ) {
 ...
 void Set_img_spectrum( string data_path ) {
	...
	//StoreMAE_style(list_pic_2d, pic_rows, pic_cols, 401 );
	//StoreCSV(list_pic_2d, pic_rows, pic_cols, 401, data_path );
...
int main() {
	...
	string data_path = "./image/720x480.jpg";
